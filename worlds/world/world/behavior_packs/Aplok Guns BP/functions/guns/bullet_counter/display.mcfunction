execute as @s[hasitem={item=gabrielaplok:ak12, location=slot.weapon.mainhand}] run function guns/bullet_counter/ak12
...
execute as @s[hasitem={item=gabrielaplok:deagle, location=slot.weapon.mainhand}] run function guns/bullet_counter/deagle
...
execute as @s[hasitem={item=gabrielaplok:m249, location=slot.weapon.mainhand}] run function guns/bullet_counter/m249
