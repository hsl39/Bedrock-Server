...
execute if score @s glock17 matches ..0 run event entity @s gabrielaplok:set_ammo_0
execute if score @s glock17 matches 1.. run event entity @s gabrielaplok:set_ammo_1