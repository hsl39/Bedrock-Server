...
execute if score @s glock18 matches ..0 run event entity @s gabrielaplok:set_ammo_0
execute if score @s glock18 matches 1.. run event entity @s gabrielaplok:set_ammo_1